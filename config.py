...
class Config:
    ...
    def set_flags(self):
        ...
        flags.DEFINE_integer("n_models", 3, "Number of models being trained in parallel by PBT.")
        flags.DEFINE_integer("n_envs_per_model", 2, "Number of environments to run in parallel per model.")
